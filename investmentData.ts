...
export const treasuryEvents: CalendarEvent[] = [
  { id: 'treasury-q1', date: '2025-02-05', title: 'Q1 Treasury Quarterly Refunding', category: 'economic', description: 'TBAC meeting & refunding announcement', time: '8:30 AM ET' },
  { id: 'treasury-q2', date: '2025-05-07', title: 'Q2 Treasury Quarterly Refunding', category: 'economic', description: 'TBAC meeting & refunding announcement', time: '8:30 AM ET' },
  { id: 'treasury-q3', date: '2025-08-06', title: 'Q3 Treasury Quarterly Refunding', category: 'economic', description: 'TBAC meeting & refunding announcement', time: '8:30 AM ET' },
  { id: 'treasury-q4', date: '2025-11-05', title: 'Q4 Treasury Quarterly Refunding', category: 'economic', description: 'TBAC meeting & refunding announcement', time: '8:30 AM ET' },
];
...
export const riskAlerts: CalendarEvent[] = [
  ...
  { id: 'risk-9', date: '2025-06-01', title: 'Debt Ceiling X-Date Risk', category: 'risk', description: 'Treasury may approach debt limit' },
  { id: 'risk-10', date: '2025-09-30', title: 'Federal Fiscal Year End', category: 'risk', description: 'Government funding deadline' },
  { id: 'risk-11', date: '2025-12-15', title: 'Year-End Funding Deadline', category: 'risk', description: 'Potential shutdown risk' },
];
...
export const allEvents = [...fomcMeetings, ...economicData, ...treasuryEvents, ...earningsData, ...riskAlerts];
